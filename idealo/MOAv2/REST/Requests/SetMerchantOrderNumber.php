...
use idealo\MOAv2\REST\Traits\HasIdealoOrderId;
...
class SetMerchantOrderNumber extends Request
{
    use HasIdealoOrderId;
    use HasParameters;
    use HasShopId;
    use HasToken;
    use IsPostRequest;

    protected $urlPath = 'shops/{shopId}/orders/{idealoOrderId}/merchant-order-number';
